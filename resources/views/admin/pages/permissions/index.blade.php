...
:root {
    ...
    --primary-dark: var(--c-secondary);
    --success: var(--c-success);
    --danger: var(--c-danger);
    --warning: var(--c-warning);
    --gray-50: var(--hover-bg);
    --gray-100: var(--hover-bg);
    --gray-200: var(--border-color);
    --gray-300: var(--input-border);
    --gray-400: var(--text-faint);
    --gray-500: var(--text-muted);
    --gray-600: var(--text-secondary);
    --gray-700: var(--text-body);
    --gray-800: var(--text-heading);
    --gray-900: var(--text-heading);
    --radius: 12px;
    --radius-sm: 8px;
...
.alert-danger { background: var(--c-secondary-light); color: var(--c-danger); }
...
.role-administrator { background: linear-gradient(135deg, var(--c-purple-light) 0%, var(--c-purple-light) 100%); color: var(--c-purple); }
.role-supervisor { background: linear-gradient(135deg, var(--c-warning-light) 0%, var(--c-warning-border) 100%); color: var(--c-warning); }
.role-staff { background: linear-gradient(135deg, var(--c-success-light) 0%, var(--c-success-border) 100%); color: var(--c-success); }
...
.parent-row { background: var(--card-bg,#fff); }
