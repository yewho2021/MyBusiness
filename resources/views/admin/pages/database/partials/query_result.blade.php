...
@if($results !== null)
    <div class="result-header">
        ...
        <div style="display:flex;gap:6px">
            ...
            <button class="tb-btn" onclick="DatabaseManager.exportResultsSQL(this)" title="Export as SQL INSERT"><i class="fas fa-file-code"></i> SQL</button>
        </div>
        @endif
    </div>
    <div class="result-wrap">
        @if(empty($results))
            <div style="text-align:center;padding:30px;color:var(--text-faint)">No results returned.</div>
        @else
