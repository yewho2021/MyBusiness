...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .error-code { font-size:72px; font-weight:700; color:#d97706; opacity:.15; line-height:1; margin-bottom:8px; }
        .icon { width:72px; height:72px; border-radius:16px; background:#fffbeb; display:flex; align-items:center; justify-content:center; margin:0 auto 24px; }
        .icon i { font-size:32px; color:#d97706; }
