...
<aside class="sidebar">
    ...
    <div class="sidebar-header" style="<?php echo e(\App\Models\Configuration::get('sidebar_header_bg') ? 'background:' . \App\Models\Configuration::get('sidebar_header_bg') . ';' : ''); ?>padding:<?php echo e(\App\Models\Configuration::get('sidebar_header_padding', '20')); ?>px;">
        <?php
        ...
        ?>
        <div class="logo" style="justify-content:<?php echo e($justifyMap[$logoAlign] ?? 'flex-start'); ?>;padding:<?php echo e($logoPadding); ?>px;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($logoType === 'image' || $logoType === 'both') && $logoImage): ?>
                    <img src="<?php echo e(asset($logoImage)); ?>" alt="<?php echo e($portalName); ?>" style="height:<?php echo e($logoHeight); ?>px;max-width:calc(var(--sidebar-width) - 40px);object-fit:contain;">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logoType === 'both'): ?>
                        <span class="logo-text"><?php echo e($portalName); ?></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php else: ?>
                    <div class="logo-icon">
                        <i class="<?php echo e($logoIcon); ?>"></i>
                    </div>
                    <span class="logo-text"><?php echo e($portalName); ?></span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    ...
    <nav class="sidebar-nav">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $menuGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($groupMenus->count() > 0 && $hasAccessibleMenu): ?>
                <div class="nav-group">
                    <span class="nav-group-title"><?php echo e($group->title); ?></span>

                    <ul class="nav-menu">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $groupMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $children = $allMenus->where('parent_id', $menu->id);
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showMenu): ?>
                                <li class="nav-item <?php echo e($hasAccessibleChildren ? 'has-children open' : ''); ?>">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasAccessibleChildren): ?>
                                        <a href="javascript:void(0)" class="nav-link <?php echo e($isChildActive ? 'parent-active' : ''); ?>" onclick="toggleSubmenu(this)">
                                            <span class="nav-icon"><i class="<?php echo e($menu->icon ?? 'fas fa-circle'); ?>"></i></span>
                                            <span class="nav-text"><?php echo e($menu->title); ?></span>
                                            <span class="nav-arrow"><i class="fas fa-chevron-down"></i></span>
                                        </a>
                                        <ul class="nav-submenu">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $accessibleChildren; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                ...
                                                <li class="nav-subitem">
                                                    <a href="<?php echo e($child->route_name ? route($child->route_name) : ($child->url ?? '#')); ?>"
                                                       class="nav-sublink <?php echo e($isChildItemActive ? 'active' : ''); ?>">
                                                        <span class="nav-icon"><i class="<?php echo e($child->icon ?? 'fas fa-circle'); ?>"></i></span>
                                                        <span class="nav-text"><?php echo e($child->title); ?></span>
                                                    </a>
                                                </li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </ul>
                                    <?php else: ?>
                                        <a href="<?php echo e($menu->route_name ? route($menu->route_name) : ($menu->url ?? '#')); ?>"
                                           class="nav-link <?php echo e($isActive ? 'active' : ''); ?>">
                                            <span class="nav-icon"><i class="<?php echo e($menu->icon ?? 'fas fa-circle'); ?>"></i></span>
                                            <span class="nav-text"><?php echo e($menu->title); ?></span>
                                        </a>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH /home/mybusiness/office.mybusiness.com.my/resources/views/admin/partials/menu_left.blade.php ENDPATH**/ ?>