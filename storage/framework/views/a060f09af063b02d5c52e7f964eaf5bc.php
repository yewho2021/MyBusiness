<?php $__env->startSection('title', 'File Structure'); ?>
...
<div class="panels">
    ...
    <div class="panel">
        ...
        <div class="panel-wrap">
            ...
            <textarea class="panel-output" id="output-files" readonly spellcheck="false"><?php echo e($fileOutput); ?></textarea>
        </div>
        <div class="panel-footer">
            <span id="meta-files-lines"><i class="fas fa-align-left"></i> <?php echo e(substr_count($fileOutput, "\n") + 1); ?> lines</span>
            <span><i class="fas fa-folder"></i> <?php echo e(base_path()); ?></span>
        </div>
    </div>
    ...
    <div class="panel">
        <div class="panel-header">
            ...
            <div class="panel-actions">
                <a href="<?php echo e(route('admin.file-structure.export-db', 'sql')); ?>" class="btn btn-outline btn-sm" style="text-decoration:none;" title="Export database as .sql" onclick="showToast('Generating .sql export...')">
                    <i class="fas fa-file-code"></i> .sql
                </a>
                <a href="<?php echo e(route('admin.file-structure.export-db', 'zip')); ?>" class="btn btn-primary btn-sm" style="text-decoration:none;" title="Export database as .zip" onclick="showToast('Generating .zip export...')">
        ...
        <div class="panel-wrap">
            ...
            <textarea class="panel-output" id="output-db" readonly spellcheck="false"><?php echo e($dbOutput); ?></textarea>
        </div>
        <div class="panel-footer">
            <span id="meta-db-lines"><i class="fas fa-align-left"></i> <?php echo e(substr_count($dbOutput, "\n") + 1); ?> lines</span>
            <span><i class="fas fa-database"></i> <?php echo e(config('database.connections.mysql.database')); ?></span>
        </div>
    </div>
</div>
...
# Task: Deep Analysis of My <?php echo e(\App\Models\Configuration::get('portal_name', config('app.name', 'Admin Portal'))); ?>


Please help me perform a comprehensive analysis of my <?php echo e(\App\Models\Configuration::get('portal_name', config('app.name', 'Admin Portal'))); ?> project.
...
<script>
const GENERATE_URL = '<?php echo e(route("admin.file-structure.generate")); ?>';
const EXPORT_URL = '<?php echo e(route("admin.file-structure.export-ai")); ?>';
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/mybusiness/office.mybusiness.com.my/resources/views/admin/pages/system/file-structure.blade.php ENDPATH**/ ?>