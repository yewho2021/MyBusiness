<?php $__env->startSection('title', 'System Patch'); ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($historyError) && $historyError): ?>
<div class="sp-card" style="border-left:4px solid var(--c-danger);">
    ...
    <div style="background:var(--c-danger-light);border-radius:8px;padding:16px;font-family:var(--font-mono);font-size:var(--fs-sm);color:var(--c-danger);word-break:break-all;"><?php echo e($historyError); ?></div>
</div>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>


<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($history) && count($history) > 0): ?>
<div class="sp-card">
    <div class="sp-h">
        <i class="fas fa-code-branch"></i> Version History (<?php echo e(count($history)); ?>)
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentVersion): ?>
            <span style="margin-left:auto;font-size:var(--fs-sm);font-weight:500;color:var(--text-muted);">Current: <span style="font-family:var(--font-mono);color:var(--c-primary);font-weight:700;">v<?php echo e($currentVersion->version_code); ?></span></span>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
    ...
    <table class="vh">
        ...
        <tbody>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <td><span class="vh-code">v<?php echo e($v->version_code); ?></span></td>
            <td>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($v->type==='rollback'): ?><span class="tag tag-purple"><i class="fas fa-undo" style="font-size:10px;"></i> Rollback</span>
                <?php elseif($v->type==='legacy'): ?><span class="tag tag-gray"><i class="fas fa-archive" style="font-size:10px;"></i> Legacy</span>
                <?php else: ?><span class="tag tag-green"><i class="fas fa-arrow-up" style="font-size:10px;"></i> Patch</span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </td>
            <td>
                <div style="font-weight:600;color:var(--text-heading);">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($v->isRollback()): ?> Restored to <span class="vh-code">v<?php echo e($v->rollback_target_code); ?></span>
                    <?php else: ?> <?php echo e($v->file_name ?? '—'); ?> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($v->description): ?><div class="vh-desc" title="<?php echo e($v->description); ?>"><?php echo e(mb_strlen($v->description) > 60 ? mb_substr($v->description, 0, 60) . '...' : $v->description); ?></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </td>
            <td style="text-align:center;"><?php echo e($v->code_files); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($v->sql_files > 0): ?><span style="font-size:var(--fs-xs);color:var(--c-purple);"> +<?php echo e($v->sql_files); ?>sql</span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></td>
            <td style="text-align:center;font-family:var(--font-mono);font-size:var(--fs-xs);"><?php echo e($v->total_backup_bytes > 0 ? $v->getBackupSizeHuman() : '—'); ?></td>
            <td style="text-align:center;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($v->status==='success'): ?><span class="tag tag-green"><i class="fas fa-check" style="font-size:10px;"></i> OK</span>
                <?php else: ?><span class="tag tag-amber"><i class="fas fa-exclamation-triangle" style="font-size:10px;"></i> <?php echo e(ucfirst($v->status)); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </td>
            <td>
                <div style="font-size:var(--fs-sm);color:var(--text-heading);"><?php echo e($v->applied_at?->format('d M Y')); ?></div>
                <div style="font-size:var(--fs-xs);color:var(--text-muted);"><?php echo e($v->applied_at?->format('H:i:s')); ?> · <?php echo e($v->admin_name); ?> · <?php echo e($v->elapsed_ms); ?>ms</div>
            </td>
            <td style="text-align:right;white-space:nowrap;">
                <button class="vh-btn vh-detail" onclick="openDetail('<?php echo e($v->version_code); ?>')"><i class="fas fa-eye"></i> Detail</button>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($idx > 0 && $v->canRestore()): ?>
                    <button class="vh-btn vh-restore" onclick="openRB('<?php echo e($v->version_code); ?>')" style="margin-left:6px;"><i class="fas fa-undo"></i> Restore</button>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </td>
        </tr>
...
<script>
const T='<?php echo e(csrf_token()); ?>', U_PREV='<?php echo e(route("admin.system-patch.preview")); ?>', U_APPLY='<?php echo e(route("admin.system-patch.apply")); ?>',
      U_VER='<?php echo e(url("system-patch/version")); ?>', U_RBP='<?php echo e(route("admin.system-patch.rollback-preview")); ?>', U_RBX='<?php echo e(route("admin.system-patch.rollback-execute")); ?>';
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/mybusiness/office.mybusiness.com.my/resources/views/admin/pages/system/patch.blade.php ENDPATH**/ ?>