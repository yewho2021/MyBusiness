    ...
    <form id="importForm" onsubmit="DatabaseManager.handleImport(event, this)">
        ...
        <div class="card">
            ...
            <div class="form-body" style="padding:20px">
                <div class="upload-zone" style="border:2px dashed #d1d5db;border-radius:10px;padding:40px;text-align:center;cursor:pointer;transition:all .2s">
                    ...
                    <div class="import-file-name" style="margin-top:12px;font-size:13px;color:#2563eb;font-weight:500"></div>
                </div>
