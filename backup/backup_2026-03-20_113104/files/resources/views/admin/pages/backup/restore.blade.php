...
@section('content')
    ...
    <div class="section-card">
        ...
        <div class="restore-info">
            ...
            <div class="info-row"><span class="info-label" style="color:#4f46e5">Changelog Content</span><span
                    class="info-value"
                    style="font-family:inherit; color:#4f46e5">{{ $run->description ?? 'No details' }}</span></div>
            @if($metadata)
