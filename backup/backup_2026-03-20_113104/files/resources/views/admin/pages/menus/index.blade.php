...
@push('styles')
<style>
:root { --primary:#6366f1; --primary-dark:#4f46e5; --success:#10b981; --danger:#ef4444; --warn:#f59e0b; --g50:#f9fafb; --g100:#f3f4f6; --g200:#e5e7eb; --g300:#d1d5db; --g400:#9ca3af; --g500:#6b7280; --g600:#4b5563; --g700:#374151; --g800:#1f2937; --g900:#111827; --r:10px; --rs:7px; }
...
.menu-section.drag-over { box-shadow:0 0 0 2px var(--primary),0 4px 12px rgba(99,102,241,.15); }
...
.menu-icon-box { width:34px; height:34px; background:linear-gradient(135deg,var(--primary),#8b5cf6); border-radius:var(--rs); display:flex; align-items:center; justify-content:center; color:#fff; font-size:13px; flex-shrink:0; }
.menu-icon-box.child { width:28px; height:28px; font-size:11px; background:linear-gradient(135deg,#818cf8,#a78bfa); }
...
/* ── Sortable feedback ───────────────────────── */
.sortable-ghost { opacity:.3; background:#eef2ff !important; }
